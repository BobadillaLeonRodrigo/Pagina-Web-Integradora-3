...
<head>
    ...
    <link rel="stylesheet" href="/integrador/assets/styles/index.css"> 
    <!-- sCRIPT BOOTSTRAP -->
    <title>informacion Rutas Tollocan</title>
</head>
<body>
   <!-- STAR NAV -->
   <div id="header">
...
<div class="row">
    ...
    <div class="col text-center">  
        <p class="text-center"><h1><em>Tollocan</em></h1></p>
    </div>
    <div class="col">
    </div> 
</div>
...
<figure>
  <img src="http://localhost/INTEGRADOR/assets/img/tollocan.png" class="rounded mx-auto d-block img-fluid" alt="maparutaTollocan">
</figure>
</section> 
<br>    
 <div class="position-relative">
    <div class="position-absolute bottom-0 start-50 translate-middle-x">
 <a href="http://localhost/INTEGRADOR/horatoll.php" class="btn btn-secondary bg-dark" tabindex="-1" role="button" aria-disabled="true">Ver Horarios</a>
</div> 
</div>
 <!--Pie de pagina-->
