  ...
  <!--Inicio de Seción-->
      <form class="bg-black">
        <div class="container bg-black">
          ...
          <label for="exampleInputEmail1" class="form-label text-white">Ingresa tu correo electronico</label>
          <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group text-center text-white">
            <label for="exampleInputEmail1" class="form-label text-white">Nueva contraseña</label>
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
          </div>
        <div class="form-group text-center pt-3">
        <label for="inputPassword5" class="form-label text-white">Confirmar contraseña</label>
        <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
        <button type="submit" class="btn"><a href="http://localhost/INTEGRADOR/iniciarsesion.php">Ingresar</a></button>
      </form>
      <br><br><br><br><br><br>
        </div>
    </div>
